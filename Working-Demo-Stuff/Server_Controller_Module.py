...
class Drone_Controller(object):
    ...
    def RunSingleIteration(self):
        ...
        tog_auto = self.joystick.get_button(1)
        tog_man = self.joystick.get_button(3)
        ...
        axis_pair = (axis_lx, axis_ly, axis_rx, axis_ry, but_cam_stick, exit_button, tog_auto, tog_man)
